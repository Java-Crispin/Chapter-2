...
public class PosterFactory {
    public static void main(String[]args){
        ...
        postersBoughtString = JOptionPane.showInputDialog(null, "How many bosters were bought today? ",
        ...
        JOptionPane.showMessageDialog(null, "The number of boxes filled was " +
